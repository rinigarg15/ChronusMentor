...
module FeatureManager
  ...
  module ClassMethods
    ...
    #
    #     [{:controller => 'some_controller', :action => 'action_1'},
    #     {:controller => 'another_controller', :action => 'single_action'}
    #     ]
    #
  ...
  def feature_accessed
    ActionController::Base.all_features.each do |feature|
