...
module Prawnto
  module TemplateHandler
    ...
    class CompileSupport
      ...
      def ssl_request?
        # Found the solution in the comment responded to this answer http://stackoverflow.com/a/4222730/857470
        # Looks like it has been changed to @controller.request.ssl? in the recent versions of prawn
