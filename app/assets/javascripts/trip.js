...
(function(window, $) {
  ...
  Trip.prototype = {
    ...
    bindResizeEvents: function() {
      ...
      // This code has been added to take care of Internet Explorer, where window.resize event is fired when any element on the page is resized.
    ...
    showCurrentTrip: function(o) {
      ...
      if (o.expose) {
        this.showExpose($(o.highlight || o.sel));
      }
    },
    ...
    setTripBlock: function(o) {
      ...
      var lessthanIe9 = o.lessthanIe9 || this.settings.lessthanIe9;
      ...
      $tripBlock
        .find(".cui-tour-step-round-"+ this.tripIndex.toString()).removeClass("cui-tour-step-inactive");  

      $tripBlock
        .find(".cui-tour-step-round-"+ this.tripIndex.toString()).addClass("btn-primary");
