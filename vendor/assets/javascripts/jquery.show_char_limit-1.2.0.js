...
(function($) {
  ...
  function generateMessage(style, currLen, charsLeft) {
    ...
    if (style == 'chars_typed') {
      ...
      var status = charsLeft >= 0 ? jsCommonTranslations.left : jsCommonTranslations.over;
      var unit = (Math.abs(charsLeft) != 1 ? jsCommonTranslations.characters : jsCommonTranslations.character);
