...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = ENV["USE_S3_BACKUP_BUCKET"]=="true" ? "d2tfpwi799910s.cloudfront.net" : "d1rl60taivbsow.cloudfront.net"
  ASSETS_HOST_URL = "talent.chronus.com"
  EMAIL_HOST_SUBDOMAIN = "talent"
  SECURE_SUBDOMAIN = 'securedemo'
...
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => ENV["USE_S3_BACKUP_BUCKET"]=="true" ? 'chronus-mentor-demo-backup' : 'chronus-mentor-demo',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "demo")

MAILGUN_DOMAIN = "demomg.chronus.com"

EMAIL_IMAGE_URL = "http://#{ASSETS_HOST_URL}"

FEED_MIGRATION_STATUS_NOTIFICATION_CHRONUS_RECIPIENTS = []
FEED_MIGRATION_FAILURE_NOTIFICATION_CHRONUS_RECIPIENTS = []

BOUNCED_MAIL_AND_SPAM_NOTIFICATION_RECIPIENTS = ['opseng@chronus.com']

SALES_DEMO_ORGANIZATION_CREATION_STATUS_NOTIFICATION_RECIPIENTS = ['cseng@chronus.com', 'sales@chronus.com']
...
EMAIL_MONITOR_ORG_URL = "https://pingdom-alert.demo.chronus.com"
PAGERDUTY_NOTIFICATION = true
PENDO_TRACKING_ENABLED = true
RESET_PENDO_GUIDE_SEEN = true
CALENDAR_SYNC_NOTIFICATION_URL = "https://mentor.demo.chronus.com/calendar_sync"
