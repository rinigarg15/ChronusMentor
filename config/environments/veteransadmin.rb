...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = ENV["USE_S3_BACKUP_BUCKET"]=="true" ? "det36q84ydv5b.cloudfront.net" : "d19xakooou01mp.cloudfront.net"
  ASSETS_HOST_URL = "mentorva.chronus.com"
  EMAIL_HOST_SUBDOMAIN = "mentorva"
  SECURE_SUBDOMAIN = 'securementorva'
  DEFAULT_SUBDOMAIN = 'mentorva'
...
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => ENV["USE_S3_BACKUP_BUCKET"]=="true" ? 'chronus-mentor-veteransadmin-backup' : 'chronus-mentor-veteransadmin',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "veteransadmin")

MAILGUN_DOMAIN = "veteransadminmg.chronus.com"
...
EMAIL_MONITOR_ORG_URL = "https://pingdom-alert-veteransadmin.chronus.com"
ENGAGEMENT_INDEX_ENABLED = true
PAGERDUTY_NOTIFICATION = true
PENDO_TRACKING_ENABLED = true
CALENDAR_SYNC_NOTIFICATION_URL = "https://mentorva.chronus.com/calendar_sync"
