...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = "d2i8n763c3nqp1.cloudfront.net"
  ASSETS_HOST_URL = "scanner.chronus.com"
  EMAIL_HOST_SUBDOMAIN = "scanner"
  SECURE_SUBDOMAIN = 'securescanner'
...
EnvSpecificConstants.generate(CronMonitorConstants, "scanner")

MAILGUN_DOMAIN = "scannermg.chronus.com"
...
EMAIL_MONITOR_ORG_URL = "https://pingdom-alert-scanner.realizegoal.com"
