...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = ENV["USE_S3_BACKUP_BUCKET"]=="true" ? "d275haui54tghu.cloudfront.net" : "d2onxlo3kggb4y.cloudfront.net"
  ASSETS_HOST_URL = "mentorge.chronus.com"
  EMAIL_HOST_SUBDOMAIN = "mentorge"
  SECURE_SUBDOMAIN = 'securementorge'
  DEFAULT_SUBDOMAIN = 'mentorge'
...
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => ENV["USE_S3_BACKUP_BUCKET"]=="true" ? 'chronus-mentor-generalelectric-backup' : 'chronus-mentor-generalelectric',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "generalelectric")

MAILGUN_DOMAIN = "generalelectricmg.chronus.com"
...
EMAIL_MONITOR_ORG_URL = "https://pingdom-alert-generalelectric.chronus.com"
