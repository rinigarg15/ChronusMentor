...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = ENV["USE_S3_BACKUP_BUCKET"]=="true" ? "db4yjik9xavd3.cloudfront.net" : "d3f5qkmb0muuw6.cloudfront.net"
  ASSETS_HOST_URL = "mentornch.chronus.com"
  EMAIL_HOST_SUBDOMAIN = "mentornch"
  SECURE_SUBDOMAIN = 'securementornch'
  DEFAULT_SUBDOMAIN = 'mentornch'
...
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => ENV["USE_S3_BACKUP_BUCKET"]=="true" ? 'chronus-mentor-nch-backup' : 'chronus-mentor-nch',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "nch")

MAILGUN_DOMAIN = "nchmg.chronus.com"
...
EMAIL_MONITOR_ORG_URL = "https://pingdom-alert-nch.chronus.com"
ENGAGEMENT_INDEX_ENABLED = false
PAGERDUTY_NOTIFICATION = true
PENDO_TRACKING_ENABLED = true
CALENDAR_SYNC_NOTIFICATION_URL = "https://mentornch.chronus.com/calendar_sync"
