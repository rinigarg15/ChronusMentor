...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = "d7sk5z1u1snm7.cloudfront.net"
  ASSETS_HOST_URL = "standby.realizegoal.com"
  EMAIL_HOST_SUBDOMAIN = "standby"
  SECURE_SUBDOMAIN = 'securestandby'
...
EnvSpecificConstants.generate(CronMonitorConstants, "standby")

MAILGUN_DOMAIN = "standbymg.realizegoal.com"
...
# #These are here especilly for scanner purpose
# #To check for code coverage, when scanner is running.
# require 'simplecov'
...
EMAIL_MONITOR_ORG_URL = "https://standby.realizegoal.com"
