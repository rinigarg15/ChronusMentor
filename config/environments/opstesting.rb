...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = ENV["USE_S3_BACKUP_BUCKET"]=="true" ? "dc37bwl0j943m.cloudfront.net" : "d12x1fgssj8gf0.cloudfront.net"
  ASSETS_HOST_URL = "opstesting.realizegoal.com"
  EMAIL_HOST_SUBDOMAIN = "opstesting"
  SECURE_SUBDOMAIN = 'secureopstesting'
...
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => ENV["USE_S3_BACKUP_BUCKET"]=="true" ? 'chronus-mentor-opstesting-backup' : 'chronus-mentor-opstesting',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "opstesting")

MAILGUN_DOMAIN = "opstestingmg.realizegoal.com"
...
EMAIL_MONITOR_ORG_URL = "https://opstesting.realizegoal.com"
