...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = ENV["USE_S3_BACKUP_BUCKET"]=="true" ? "d1evtz8yz9zzr5.cloudfront.net" : "dwmfjbgkhkazs.cloudfront.net"
  ASSETS_HOST_URL = "mentoreu.chronus.com"
  EMAIL_HOST_SUBDOMAIN = "mentoreu"
  SECURE_SUBDOMAIN = 'secureproductioneu'
  # Any change in DEFAULT_SUBDOMAIN, have to be taken care in HostingRegions::SUBDOMAIN_MAPPING
  DEFAULT_SUBDOMAIN = 'mentoreu'
...
#EU Endpoint is specifiied in s3_host_name
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => ENV["USE_S3_BACKUP_BUCKET"]=="true" ? 'chronus-mentor-productioneu-backup' : 'chronus-mentor-productioneu',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "productioneu")

MAILGUN_DOMAIN = "productioneumg.chronus.com"
...
EMAIL_MONITOR_ORG_URL = "https://pingdom-alert-eu.chronus.com"
ENGAGEMENT_INDEX_ENABLED = true
PENDO_TRACKING_ENABLED = true
PAGERDUTY_NOTIFICATION = true
CALENDAR_SYNC_NOTIFICATION_URL = "https://mentoreu.chronus.com/calendar_sync"
