...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_HOST_URL = "mentor.realizegoal.com"
  ASSETS_BUCKET_URL = ENV["USE_S3_BACKUP_BUCKET"]=="true" ? "d3ktkb461kwkqx.cloudfront.net" : "dy6c61w60usix.cloudfront.net"
...
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => ENV["USE_S3_BACKUP_BUCKET"]=="true" ? 'chronus-mentor-staging-backup' : 'chronus-mentor-staging',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "staging")

MAILGUN_DOMAIN = "stagingmg.realizegoal.com"
...
ACTIVE_ADMINS_NOTIFICATION_RECIPIENTS = ["apollodev+sendmail@chronus.com"]
...
EMAIL_MONITOR_ORG_URL = "https://pingdom-alert-staging.realizegoal.com"
ENGAGEMENT_INDEX_ENABLED = true
PENDO_TRACKING_ENABLED = true
CALENDAR_SYNC_NOTIFICATION_URL = "https://mentor.realizegoal.com/calendar_sync"