...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = "dthful0290qc0.cloudfront.net"
  ASSETS_HOST_URL = "releasestaging1.realizegoal.com"
  EMAIL_HOST_SUBDOMAIN = "releasestaging1"
  SECURE_SUBDOMAIN = 'securereleasestaging1'
...
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => 'chronus-mentor-releasestaging1',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "releasestaging1")

MAILGUN_DOMAIN = "releasestaging1mg.realizegoal.com"
...
EMAIL_MONITOR_ORG_URL = "https://releasestaging1.realizegoal.com"
