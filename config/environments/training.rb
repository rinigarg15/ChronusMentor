...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = "d1bl8y5ylmq03r.cloudfront.net"
  ASSETS_HOST_URL = "training.realizegoal.com"
  EMAIL_HOST_SUBDOMAIN = "training"
  SECURE_SUBDOMAIN = 'securetraining'
  DEFAULT_SUBDOMAIN = 'training'
...
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => 'chronus-mentor-training',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "training")

MAILGUN_DOMAIN = "trainingmg.chronus.com"
...
EMAIL_MONITOR_ORG_URL = "https://rails4.realizegoal.com"
