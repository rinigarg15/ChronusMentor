...
ChronusMentorBase::Application.configure do
  ...
  ASSETS_BUCKET_URL = "d3tl8pxwmxxpjl.cloudfront.net"
  ASSETS_HOST_URL = "releasestaging2.realizegoal.com"
  EMAIL_HOST_SUBDOMAIN = "releasestaging2"
  SECURE_SUBDOMAIN = 'securereleasestaging2'
...
GENERAL_OPTIONS = {
  :storage => :s3,
  :bucket => 'chronus-mentor-releasestaging2',
  :s3_protocol => "https",
...
EnvSpecificConstants.generate(CronMonitorConstants, "releasestaging2")

MAILGUN_DOMAIN = "releasestaging2mg.realizegoal.com"

EMAIL_IMAGE_URL = "http://#{ASSETS_HOST_URL}"

# Add the mailing list of feature team which leased the environment
...
EMAIL_MONITOR_ORG_URL = "https://releasestaging2.realizegoal.com"
